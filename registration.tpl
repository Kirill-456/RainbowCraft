...
<div class="baseform">
	...
	[registration]
		<tr>
			...
			<td>
				<input name="name" id="name" style="width:175px; margin-right: 6px;" class="f_input" type="text"><input id="check_button" title="Проверить доступность логина для регистрации" onclick="CheckLogin(); return false;" value="Проверить имя" type="button">
